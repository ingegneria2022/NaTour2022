...
public class ControllerRegisterUser {
    ...
    public ControllerRegisterUser(UserDao userDao, JdbcTemplate jdbcTemplate) {
    ...
    @GetMapping("/{username}/visualizzautente")
    public List<User> VisualizzaUtente(@PathVariable("username") String username) throws Exception{
        return registerUserService.VisualizzaUtente(username);
    }
}
