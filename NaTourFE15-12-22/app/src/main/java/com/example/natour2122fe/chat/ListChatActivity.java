...
public class ListChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChatClient client = new ChatClient.Builder("5kmnk6kurq3p", getApplicationContext())
        ...
        client.connectUser(
                user,
                "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoicGVwcGUxIn0.olkaVUOAbXMpg4lw1YUI-nryU1TRI_wdmdgJZNCtQoE"
        ).enqueue();
