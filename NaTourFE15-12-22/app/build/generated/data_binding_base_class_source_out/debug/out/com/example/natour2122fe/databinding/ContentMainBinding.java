...
public final class ContentMainBinding implements ViewBinding {
  ...
  private ContentMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnGoogle,
      @NonNull Button btnSignin, @NonNull Button btnSignup, @NonNull TextView textView) {
  ...
  public static ContentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContentMainBinding((ConstraintLayout) rootView, btnGoogle, btnSignin, btnSignup,
          textView);
    }
