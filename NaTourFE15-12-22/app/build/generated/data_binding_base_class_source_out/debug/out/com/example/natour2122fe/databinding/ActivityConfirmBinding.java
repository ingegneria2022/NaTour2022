...
public final class ActivityConfirmBinding implements ViewBinding {
  ...
  private ActivityConfirmBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnVerify,
      @NonNull EditText etCode) {
  ...
  public static ActivityConfirmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityConfirmBinding((ConstraintLayout) rootView, btnVerify, etCode);
    }
